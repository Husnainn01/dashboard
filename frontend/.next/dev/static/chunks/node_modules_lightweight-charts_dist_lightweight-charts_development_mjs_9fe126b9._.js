...
"[project]/node_modules/lightweight-charts/dist/lightweight-charts.development.mjs [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/fancy-canvas/index.mjs [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/fancy-canvas/size.mjs [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$element$2d$bitmap$2d$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__$3c$export__bindTo__as__bindCanvasElementBitmapSizeTo$3e$__ = __turbopack_context__.i("[project]/node_modules/fancy-canvas/canvas-element-bitmap-size.mjs [client] (ecmascript) <export bindTo as bindCanvasElementBitmapSizeTo>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$rendering$2d$target$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/fancy-canvas/canvas-rendering-target.mjs [client] (ecmascript)");
;
...
function suggestChartSize(originalSize) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
        width,
        height
    });
}
...
function createBoundCanvas(parentElement, size) {
    ...
    const binding = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$element$2d$bitmap$2d$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__$3c$export__bindTo__as__bindCanvasElementBitmapSizeTo$3e$__["bindCanvasElementBitmapSizeTo"])(canvas, {
...
class PriceAxisWidget {
    constructor(pane, options, rendererOptionsProvider, side){
        ...
        this._private__canvasBinding = createBoundCanvas(this._private__cell, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 16,
            height: 16
        }));
        ...
        canvas.style.left = '0';
        canvas.style.top = '0';
        this._private__topCanvasBinding = createBoundCanvas(this._private__cell, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 16,
            height: 16
        }));
    ...
    _internal_setSize(newSize) {
        if (this._private__size === null || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["equalSizes"])(this._private__size, newSize)) {
    ...
    _internal_paint(type) {
        ...
        if (type !== 1 /* InvalidationLevel.Cursor */ ) {
            ...
            const target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$rendering$2d$target$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["tryCreateCanvasRenderingTarget2D"])(this._private__canvasBinding);
            if (target !== null) {
        ...
        const topTarget = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$rendering$2d$target$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["tryCreateCanvasRenderingTarget2D"])(this._private__topCanvasBinding);
        if (topTarget !== null) {
...
class PaneWidget {
    constructor(chart, state){
        this._private__size = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 0,
            height: 0
        });
        ...
        this._private__canvasBinding = createBoundCanvas(paneWrapper, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 16,
            height: 16
        }));
        this._private__canvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__canvasSuggestedBitmapSizeChangedHandler);
        ...
        canvas.style.left = '0';
        canvas.style.top = '0';
        this._private__topCanvasBinding = createBoundCanvas(paneWrapper, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 16,
            height: 16
        }));
        this._private__topCanvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__topCanvasSuggestedBitmapSizeChangedHandler);
    ...
    _internal_setPriceAxisSize(width, position) {
        ...
        ensureNotNull(priceAxisWidget)._internal_setSize((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width,
    ...
    _internal_setSize(newSize) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["equalSizes"])(this._private__size, newSize)) {
            return;
        }
        this._private__size = newSize;
        this._private__isSettingSize = true;
...
class TimeAxisWidget {
    constructor(chartWidget, horzScaleBehavior){
        ...
        this._private__canvasBinding = createBoundCanvas(this._private__dv, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 16,
            height: 16
        }));
        this._private__canvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__canvasSuggestedBitmapSizeChangedHandler);
        ...
        canvas.style.left = '0';
        canvas.style.top = '0';
        this._private__topCanvasBinding = createBoundCanvas(this._private__dv, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width: 16,
            height: 16
        }));
        this._private__topCanvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__topCanvasSuggestedBitmapSizeChangedHandler);
    ...
    _internal_setSizes(timeAxisSize, leftStubWidth, rightStubWidth) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["equalSizes"])(this._private__size, timeAxisSize)) {
        ...
        if (this._private__leftStub !== null) {
            this._private__leftStub._internal_setSize((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
                width: leftStubWidth,
                height: timeAxisSize.height
            }));
        }
        if (this._private__rightStub !== null) {
            this._private__rightStub._internal_setSize((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
...
class ChartWidget {
    ...
    _internal_resize(width, height, forceRepaint = false) {
        ...
        const sizeHint = suggestChartSize((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
            width,
            height
        }));
    ...
    _private__adjustSizeImpl() {
        ...
        for(let paneIndex = 0; paneIndex < this._private__paneWidgets.length; ++paneIndex){
            ...
            paneWidget._internal_setSize((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
                width: paneWidth,
                height: paneHeight
            }));
            if (this._private__isLeftAxisVisible()) {
        ...
        this._private__timeAxisWidget._internal_setSizes((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$size$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["size"])({
...
//# sourceMappingURL=node_modules_lightweight-charts_dist_lightweight-charts_development_mjs_9fe126b9._.js.map